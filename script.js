const weatherApi = {
    key: "678ae82dcd9ac8f5958779ebdeb0eb5e",
  ...
  function showWeatherImage(WeatherType) {
      if(WeatherType.textContent === 'Clear') {
          document.body.style.backgroundImage = "url('hddd.jpg')"
      }
      else if(WeatherType.textContent === 'Clouds') {
          document.body.style.backgroundImage = "url('gandu.jpg')"
      }
...
//     buttonColorLight: '#ff7', // default: '#fff'
